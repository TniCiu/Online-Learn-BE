...
export const getAllInvoice = async (page = 0, size = 5) => {
    try {
        const res = await privateInstance.get(
            `/invoices?page=${page}&size=${size}&isDeleted=false`
        );
        return res.content;
    } catch (error) {
        return Promise.reject(error);
...
export const softDeleteInvoice = async (id) => {
    try {
        return await privateInstance.delete(`/invoices/delete/soft/${id}`);
    } catch (error) {
        return Promise.reject(error);
    }
};
...
export const getAllInvoiceDeleted = async (page = 0, size = 5) => {
    try {
        const res = await privateInstance.get(
            `/invoices?isDeleted=true&page=${page}&size=${size}`
        );
        return res.content;
    } catch (error) {
        return Promise.reject(error);
...
export const restoreInvoieById = async (id) => {
    try {
        return await privateInstance.put(`/invoices/${id}/restore`);
    } catch (error) {
        return Promise.reject(error);
    }
};
