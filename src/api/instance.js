...
export const userInstance = axios.create({
    baseURL: "http://localhost:8000/api/v1/me",
});
...
export const privateInstance = axios.create({
    baseURL: "http://localhost:8000/api/v1/private",
});

export const instructorInstance = axios.create({
    baseURL: "http://localhost:8000/api/v1/instructor",
});

export const chatInstance = axios.create({
    baseURL: "http://localhost:8000/api/v1/chats",
});
