...
export default function NotificationItem({ iconBtn }) {
    ...
    const handleReadAll = () => {
        ...
        const fetchApi = async () => {
            try {
                ...
                notification.notifications.forEach((noti) => {
                    noti.read = true;
                });
        ...
        switch (type) {
            case "post":
                return (
                    "/posts/" +
                    noti.postTitle +
                    (noti.commentId ? "?commentId=" + +noti.commentId : "")
                );
            case "course":
    ...
    return (
        <div className="w-full max-w-sm px-1 w-full">
                                ...
                                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5 bg-custom-1">
                                    <div className="relative ">
                                        <div
                                            className={clsx(
                                                styles.header,
                                                "font-semibold sm:text-lg text-base  flex justify-between items-center"
                                            )}
                                        >
                                        ...
                                        <div
                                            className={clsx(
                                                "sm:px-[18px] px-3 flex py-1.5 max-sm:flex-col bg-gray-200 text-xs font-medium sm:gap-5 gap-2 justify-between max-sm:items-center"
                                            )}
                                        >
                                            <div className="flex gap-2">
                                                <div
                                                    ...
                                                    className={clsx(
                                                        "rounded-lg sm:px-[18px] px-[10px] py-1.5 flex items-center gap-2",
                                                        {
                                                            "bg-white":
                                                                type === "ALL",
                                                        }
                                                ...
                                                <div
                                                    ...
                                                    className={clsx(
                                                        "rounded-lg sm:px-[18px] px-[10px] flex items-center gap-2",
                                                        {
                                                            "bg-white":
                                                                type ===
                                                                "UNREAD",
                                            ...
                                            <div className="flex items-center mr-2 max-sm:justify-center">
                                                <div
                                                    className="btnCss sm:w-[24px] "
                                                    onClick={
