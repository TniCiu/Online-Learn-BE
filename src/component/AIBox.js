...
const AIBox = ({
    ...
    const [showAIBoxState, setShowAIBoxState] = useState(showAIBox); // true: Hiển thị ra danh sách sub action chức năng da chon, false: khong hien thi
    ...
    function fixJsonError(jsonString) {
        try {
            ...
            try {
                ...
                // console.error("correctedJsonString", correctedJsonString);
                        ...
                        <div>
                            <div className="w-full flex items-center gap-1 border-b-1 border-gray-200 pb-2">
                                ...
                                <div className="flex-1 flex gap-1l">
                                    <span className="text-xs font-semibold bg-gray-200 rounded-md px-2 py-1 ">
                            ...
                            {AIObject.action === ACTION_AI.GENERATE_IDEA && (
                                <div className="flex gap-2 px-2 py-1 border-1 border-gray-300">
                                    <input
                                        ...
                                        className="flex-1 py-1.5 px-2 focus:ouline-none focus:ring-0 focus:border-0 focus:border-none bg-transparent text-black focus-within:outline-0 text-sm font-light"
                                        type="text"
                                        autoFocus={true}
