...
const ViewPost = ({ adminView = false }) => {
    ...
    useEffect(() => {
        ...
        var fetchApi = async () => {
            try {
                const result = await postService.getPostByTitle(
                    title,
                    showCommnentById,
                    pagination
                );
            ...
            >
                ...
                <div className="w-[800px] px-3 mx-auto z-[2] flex flex-col justify-between">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="">
                            <button className="cursor-pointer hover:opacity-70 shadow-white bg-gray-200 transition-all p-2 rounded-full">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="white"
                                    viewBox="0 0 24 24"
