...
export function InstructorNav() {
    const [listOpen, setListOpen] = useState(["overviewLink"]);
                    ...
                    <div className={clsx(styles.listItem)}>
                        <Link
                            ...
                            className={clsx(
                                ...
                                {
                                    [styles.active]:
                                        listOpen.includes("overviewLink"),
                                }
                            )}
                        >
                            <Ink></Ink>
                            ...
                            >
                                <ul className={clsx(styles.subList)}>
                                    ...
                                    <SubItem
                                        title={2}
                                        path={
                                            "/instructor-dashboard/courses/history-delete"
                                        }
                                    ></SubItem>
                                </ul>
                            </div>
                        ...
                        {listOpen.includes("invoiceLink") && (
                            ...
                            >
                                <ul className={clsx(styles.subList)}>
                                    <SubItem
                                        path={
                                            "/instructor-dashboard/invoice/list"
                                        }
                                    ></SubItem>
                                    <SubItem
                                        title={2}
                                        path={
                                            "/instructor-dashboard/invoice/history-delete"
                                        }
                                    ></SubItem>
                                </ul>
                            </div>
