...
function List() {
    ...
    const handleChangeStatusCourse = async (status) => {
    ...
    const handleRemoveCourse = (deleteId) => {
        const fetchApi = async () => {
            toast.promise(
                instructorService.softDeleteCourse(deleteId, page, selected),
                {
                    loading: "Removing...",
                    success: (data) => {
    ...
    const handleRemoveListCourse = async () => {
        toast.promise(instructorService.softDeleteListCourse(selectedRow), {
            loading: "Removing...",
            success: () => {
                setReRender(!reRender);
                setModalContent({ ...modalContent, isOpen: false });
    ...
    const openDeleteModal = () => {
        setModalContent({
            ...modalContent,
            isOpen: true,
            handleRemove: handleRemoveListCourse,
    ...
    const handleSearchInputChange = (e) => {
        ...
        const fetchApi = async () => {
            try {
                const result =
                    await instructorService.getAvailableCourseByNameAndCategory(
                        e.target.value,
                        category,
                        page,
                        selected
    ...
    useEffect(() => {
        ...
        const fetchApi = async () => {
            try {
                const result =
                    await instructorService.getListCourseDraftOrPublishedAndAvailableAndCategory(
                        statusCourse,
                        category,
                        page,
                        selected
