...
const initFormData = {
    ...
    description:
        "<p>This course covers advanced JavaScript concepts and techniques.</p>",
    price: "1500",
    thumbnail:
        "https://res.cloudinary.com/dhydbv51p/image/upload/v1744022693/dream_chasers_v2/1744022692457-thumbnail.jpg",
    categories: ["643f1b2e1c4d2b001e5f6a7d", "643f1b2e1c4d2b001e5f6a7e"],
    sections: [
        {
            ...
            lessons: [
                {
                    ...
                    description:
                        "Learn the basics of JavaScript and its importance in web development.",
                    video: "https://example.com/videos/js-intro.mp4",
                    linkVideo: "https://example.com/videos/js-intro.mp4",
                },
                {
                    title: "Variables and Data Types",
                    description:
                        "Understand variables, constants, and data types in JavaScript.",
                    video: "https://example.com/videos/js-variables.mp4",
                    linkVideo: "https://example.com/videos/js-variables.mp4",
                },
            ],
        },
        {
            ...
            lessons: [
                {
                    ...
                    description:
                        "Learn about closures and scope in JavaScript.",
                    video: "https://example.com/videos/js-closures.mp4",
                    linkVideo: "https://example.com/videos/js-closures.mp4",
                },
                {
                    title: "Asynchronous JavaScript",
                    description:
                        "Understand promises, async/await, and event loops.",
                    video: "https://example.com/videos/js-async.mp4",
                    linkVideo: "https://example.com/videos/js-async.mp4",
                },
            ],
        },
        {
            ...
            lessons: [
                {
                    ...
                    description:
                        "Learn how to build a simple to-do app using JavaScript.",
                    video: "https://example.com/videos/js-todo.mp4",
                    linkVideo: "https://example.com/videos/js-todo.mp4",
                },
                {
                    title: "JavaScript Debugging",
                    description:
                        "Learn how to debug JavaScript code effectively.",
                    video: "https://example.com/videos/js-debugging.mp4",
                    linkVideo: "https://example.com/videos/js-debugging.mp4",
                },
            ],
        },
    ],
...
function InstructorCreateCourse({ adminView = false, isEdit = false }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (isEdit) {
            if (formData.author.email !== user.email) {
                    ...
                    {!adminView && (
                        <div className="flex mt-3 mb-6 justify-end items-center gap-3">
                            <div className="center gap-0 font-medium bg-white rounded-lg px-3">
                                <div>
                                    By creating a course on our platform, you
